...
mkdir /ven /sec /publico /adm

#creates the users groups
groupadd GRP_ADM
groupadd GRP_VEN
groupadd GRP_SEC

# creating GRP_ADM users
...
# specifying permissions of the directories
